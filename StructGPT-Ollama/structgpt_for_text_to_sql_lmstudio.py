...
class ChatGPT:
    ...
    def query_API_to_get_message(self, messages, max_output_len):
        """Query LM Studio API using OpenAI-compatible chat completions endpoint"""
        while True:
            try:
                ...
                print('Connection Error - Is LM Studio running?\nRetrying...')
                time.sleep(20)
...
def main(args, all_data, idx):
    # No OpenAI configuration needed - using LM Studio API
